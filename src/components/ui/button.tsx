  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        gradient: "gradient-primary text-white hover:opacity-90 hover:scale-105 active:scale-95 shadow-md hover:shadow-xl",
        glass: "glass-effect hover:bg-background/90 hover:scale-105 active:scale-95",
        premium: "bg-gradient-to-r from-primary via-secondary to-accent text-white font-semibold hover:opacity-90 hover:scale-105 active:scale-95 shadow-lg hover:shadow-xl",
      },
      size: {
